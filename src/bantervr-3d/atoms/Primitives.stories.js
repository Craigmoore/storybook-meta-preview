import { banterVrStory, hexToVec } from '../story.js';
...
export const Box = {
  ...
  render: ({ width, height, depth, color }) => banterVrStory((_, BS) => {
...
export const Sphere = {
  ...
  render: ({ radius, color }) => banterVrStory((_, BS) => {
    const [r, g, b] = hexToVec(color);
...
export const Cylinder = {
  ...
  render: ({ radiusTop, radiusBottom, height, color }) => banterVrStory((_, BS) => {
    const [r, g, b] = hexToVec(color);
...
export const Cone = {
  ...
  render: ({ radius, height, color }) => banterVrStory((_, BS) => {
    const [r, g, b] = hexToVec(color);
...
export const Torus = {
  ...
  render: ({ radius, tube, color }) => banterVrStory((_, BS) => {
    const [r, g, b] = hexToVec(color);
