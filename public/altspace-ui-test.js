// Altspace UI demo — load via <script src="..."> in index.html or paste into
// the browser console. Demonstrates all known-good patterns for BanterUI on
// the Altspace (SideQuest Creator SDK) fork — same rules as upstream Banter,
// since the UI Toolkit bridge is unchanged there as of this branch.
//
...
window.addEventListener('bs-loaded', () => {
  ...
  scene.On('unity-loaded', async () => {
    ...
    console.log('[altspace-ui-demo] done');
  });
});
