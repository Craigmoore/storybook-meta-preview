// Lightweight mock of the BS namespace for browser preview, targeting the
// Altspace (SideQuest Creator SDK) fork of BanterVR — the 3D geometry/
// material component API (BanterBox/BanterSphere/BanterCylinder/BanterCone/
// BanterTorus/BanterTorusKnot/BanterMaterial and their config properties) is
// confirmed unchanged from upstream Banter on that branch (see
// docs/setup-altspace-3d.md), so this is a straight copy of
// bantervr-3d's mock. Implements enough of the 3D system to:
