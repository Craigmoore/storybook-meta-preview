...
export default { title: 'BanterVR-UI/Molecules/Labels' };
...
export const Scoreboard = {
  ...
  render: ({ heading, value, headingSize, valueSize }) => banterUiStory((scene, BS) => {
...
export const StatusBadge = {
  ...
  render: ({ text, bgColor, textColor, fontSize }) => banterUiStory((scene, BS) => {
