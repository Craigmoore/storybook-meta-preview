...
export default { title: 'BanterVR-UI/Atoms/Inputs' };
...
export const Slider = {
  ...
  render: ({ min, max, value, width, height }) => banterUiStory((scene, BS) => {
...
export const Toggle = {
  ...
  render: ({ checked, width, height }) => banterUiStory((scene, BS) => {
