/**
 * Marching Cubes — JS port of the classic Paul Bourke implementation.
 * Original JS port by Mikola Lysenko.
 */
    ...
    for (x[1] = 0; x[1] < dims[1] - 1; ++x[1], ++n) {
      for (x[0] = 0; x[0] < dims[0] - 1; ++x[0], ++n) {
        ...
        for (let i = 0; i < 12; ++i) {
          ...
          const d  = a - b;
          const epsilon = 1e-6;
          const t = a / (d + (Math.abs(d) < epsilon ? epsilon : 0));
          for (let j = 0; j < 3; ++j) {
