...
export default { title: 'Altspace-UI/Molecules/ScrollView' };
...
export const VerticalList = {
  ...
  render: ({ itemCount, itemHeight, panelHeight }) => altspaceUiStory((scene, BS) => {
...
export const HorizontalList = {
  ...
  render: ({ itemCount, itemWidth, panelWidth }) => altspaceUiStory((scene, BS) => {
...
export const MixedContent = {
  ...
  render: ({ panelHeight }) => altspaceUiStory((scene, BS) => {
