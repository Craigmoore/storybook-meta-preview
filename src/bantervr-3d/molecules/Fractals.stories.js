...
export default { title: 'BanterVR-3D/Molecules/Fractals' };
...
export const FractalTree = {
  ...
  render: ({ depth, branchAngle, spread, lengthDecay, seed }) => banterVrStory((_, BS) => {
...
export const SierpinskiTetrahedron = {
  ...
  render: ({ order, scale }) => banterVrStory((_, BS) => {
...
export const MengerSponge = {
  ...
  render: ({ level, color }) => banterVrStory((_, BS) => {
