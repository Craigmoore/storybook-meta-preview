...
// Altspace (SideQuest Creator SDK) fork of BanterVR — same UI Toolkit
// component API (UILabel/UIButton/UISlider/UIToggle/UIScrollView/
// UIVisualElement/BanterUIPanel) as upstream Banter, kept as its own copy
// so it can diverge if Altspace's runtime changes. Implements enough of the
// UI system to:
//   (a) render approximate HTML for the browser preview
//   (b) capture a serialised scene graph that the inject script
